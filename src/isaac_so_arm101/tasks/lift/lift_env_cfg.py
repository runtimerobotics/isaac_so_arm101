...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        object_to_ee_position = ObsTerm(func=mdp.object_to_ee_position_in_robot_root_frame)
        object_goal = ObsTerm(func=mdp.generated_commands, params={"command_name": "object_pose"})
...
class RewardsCfg:
    ...
    closing_gripper_near_object = RewTerm(func=mdp.gripper_close_near_object, params={"threshold": 0.08}, weight=4.0)

    lifting_object = RewTerm(func=mdp.object_is_lifted, params={"minimal_height": 0.04}, weight=15.0)

    lifting_object_progress = RewTerm(
        func=mdp.object_lift_height,
        params={"minimal_height": 0.015, "std": 0.06},
        weight=6.0,
    )
